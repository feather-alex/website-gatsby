    ...
    window.fcWidget.init({
      ...
      config: {
        ...
        headerProperty: {
          ...
          fontName: "Centra No2",
          fontUrl:
            "https://cdn.livefeather.com/fonts/centra/CentraNo2-Bold.woff2",
          hideChatButton: true,
        },
        content: {
          placeholders: {
          ...
          headers: {
            ...
            faq_search_not_available:
              "Nothing matches your search for {{query}}",
            ...
            channel_response: {
              offline:
                "Feather will be back soon. Leave us a message and we'll get back to you",
              online: {
                minutes: {
