...
//     Analytics.trackEvent(NAVBAR.CLICK_LINK, clickNavBarLinkPayloadMappings({ currentLink }));
//   };

//   handleMobileNavLinkClick = (currentLink: string) => () => {
//     Analytics.trackEvent(NAVBAR.MOBILE_CLICK_LINK, clickNavBarLinkPayloadMappings({ currentLink }));
