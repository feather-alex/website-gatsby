...
describe("Cart - Selectors", () => {
  ...
  it("should return the value of: unavailableItems", () => {
    ...
    const selected = selectors.getUnavailableItems({
      cart: state,
    } as GlobalState);
  ...
  describe("cartContainsUnavailableProducts", () => {
    it("should return true if there are unavailable items", () => {
      ...
      const selected = selectors.getCartContainsUnavailableProducts({
        cart: state,
      } as GlobalState);
  ...
  describe("getRecommendations", () => {
    it("should return the recommendations", () => {
      ...
      const selected = selectors.getRecommendations({
        cart: state,
      } as GlobalState);
  ...
  describe("getIsRecommendationsFetching", () => {
    it("should return recommendations fetching bool", () => {
      ...
      const selected = selectors.getIsRecommendationsFetching({
        cart: state,
      } as GlobalState);
  ...
  describe("getRecommendationsError", () => {
    it("should return recommendations fetching bool", () => {
      ...
      const selected = selectors.getRecommendationsError({
        cart: state,
      } as GlobalState);
  ...
  describe("getPromoDescription", () => {
    it("should get description for fixed discount", () => {
      ...
      const selected = selectors.getPromoDescription({
        cart: state,
      } as GlobalState);
  ...
  describe("getCartSubtotal", () => {
    it("should return 0 if the rental length has not been set", () => {
      const selected = selectors.getCartSubtotal({
        cart: state,
  ...
  describe("getIsCartMinimumMet", () => {
    ...
    it("should return false if the subtotal is lower than the cartMinimum", () => {
      ...
      const selected = selectors.getIsCartMinimumMet({
        cart: state,
        plan: planState,
      } as GlobalState);
