...
import { CartItem, ProductIdentifiers, ProductRecommendation, PromoInfo, PromoType } from './cart.types';
...
describe('Cart - Actions', () => {
  ...
  describe('getUnavailableCartItems', () => {
    ...
    it('should handle a successful response', () => {
      ...
      const actualAction = actions.getUnavailableProductsSuccess(unavailableItems);
