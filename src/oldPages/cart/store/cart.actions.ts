...
export const GET_UNAVAILABLE_PRODUCTS_REQUEST =
  "GET_UNAVAILABLE_PRODUCTS_REQUEST";
export const GET_UNAVAILABLE_PRODUCTS_SUCCESS =
  "GET_UNAVAILABLE_PRODUCTS_SUCCESS";
export const GET_UNAVAILABLE_PRODUCTS_FAILURE =
...
export type AddToCartAction = FluxStandardAction<
  typeof ADD_ITEM_TO_CART,
  CartItem
>;
export type RemoveFromCartAction = FluxStandardAction<
  typeof REMOVE_ITEM_FROM_CART,
  CartItem
>;
export type UpdateCartItemsAction = FluxStandardAction<
...
export type GetUnavailableProductsRequestAction = FluxStandardAction<
  typeof GET_UNAVAILABLE_PRODUCTS_REQUEST
>;
...
export type GetRecommendationRequestAction = FluxStandardAction<
  typeof GET_RECOMMENDATIONS_REQUEST
>;
...
export type CartActions =
  ...
  | FluxStandardAction<
      typeof GET_UNAVAILABLE_PRODUCTS_SUCCESS,
      { unavailableItems: ProductIdentifiers[] }
    >
  | FluxStandardAction<
      typeof GET_UNAVAILABLE_PRODUCTS_FAILURE,
      { error: APIError }
    >
  ...
  | FluxStandardAction<
      typeof GET_RECOMMENDATIONS_SUCCESS,
...
export type UpdateUnavailableItems = (
  updatedUnavailableItems: ProductIdentifiers[]
) => CartActions;
export const updateUnavailableItems: UpdateUnavailableItems = (
  updatedUnavailableItems: ProductIdentifiers[]
) => ({
...
export type GetRecommendationsSuccess = (
  recommendations: ProductRecommendation[]
) => CartActions;
...
export const getRecommendationsSuccess: GetRecommendationsSuccess = (
  recommendations: ProductRecommendation[]
) => ({
...
export const getRecommendationsFailure: GetRecommendationsFailure = (
  error: APIError
) => ({
...
export type NormalizeCartPrices = (
  membershipState: MembershipState
) => CartActions;
export const normalizeCartPrices: NormalizeCartPrices = (
  membershipState: MembershipState
) => ({
...
export type GetUnavailableProductsSuccess = (
  unavailableItems: ProductIdentifiers[]
) => CartActions;
...
export const getUnavailableProductsFailure: GetUnavailableProductsFailure = (
  error: APIError
) => ({
