...
export const getNumberOfItemsInCart = ({ cart }: GlobalState) => cart.items.length;

export const getUnavailableItems = ({ cart }: GlobalState) => cart.unavailableItems;
...
export const getRecommendations = ({ cart }: GlobalState) => cart.recommendations;
export const getIsRecommendationsFetching = ({ cart }: GlobalState) => cart.isRecommendationsFetching;
export const getRecommendationsError = ({ cart }: GlobalState) => cart.recommendationsError;
...
export const getCartSubtotal = createSelector(getCartItems, getRentalLength, (cartItems, rentalLength) => {
...
export const getCartTotals = createSelector(
  ...
  (subtotal, membershipFee, deliveryFee) => {
    const total = membershipFee !== null && deliveryFee !== null ? subtotal + membershipFee + deliveryFee : subtotal;
...
export const getIsCartMinimumMet = createSelector(getCartSubtotal, getCartMinimum, (subtotal, cartMinimum) => {
