...
export type LoadSearchProductsSuccess = (
  payload: ProductListResponse
) => FluxStandardAction;

export const loadSearchProductsSuccess: LoadSearchProductsSuccess = (
  payload: ProductListResponse
) => ({
...
export const loadSearchProductsFailure: LoadSearchProductsFailure = (
  error: APIError
) => ({
...
export type LoadSearchPackagesSuccess = (
  payload: FullPackageDetails[]
) => FluxStandardAction;

export const loadSearchPackagesSuccess: LoadSearchPackagesSuccess = (
  payload: FullPackageDetails[]
) => ({
...
export const loadSearchPackagesFailure: LoadSearchPackagesFailure = (
  error: APIError
) => ({
