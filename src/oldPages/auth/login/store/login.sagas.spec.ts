  ...
  describe("Login", () => {
    ...
    it("should handle successfully logging in", () => {
      ...
      const expiresValue = new Date(
        new Date().getTime() + apiResponse.expiresIn * 1000
      );
      ...
      return expectSaga(handleLogin, action)
        ...
        .provide([
          ...
          [
            matchers.call(Cookies.set, "token", apiResponse.token, {
              expires: expiresValue,
            }),
            noop,
          ],
          [
            matchers.call(Analytics.tatariIdentify, apiResponse.customerId),
            noop,
          ],
