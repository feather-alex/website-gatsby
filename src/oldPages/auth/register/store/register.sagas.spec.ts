...
import { registerRequest, registerSuccess, registerFailure } from './register.actions';
...
describe('Registration Sagas', () => {
  ...
  it('should handle successfully registering', () => {
    ...
    return expectSaga(handleRegister, action)
      .provide([
        [matchers.call([Request, 'send'], RequestMethod.POST, '/auth/register', undefined, credentials, true), {}]
      ])
      .put(registerSuccess())
      .run();
  });
  ...
  it('should handle unsuccessfully registering', () => {
    ...
    return expectSaga(handleRegister, action)
      .provide([
        [
          matchers.call([Request, 'send'], RequestMethod.POST, '/auth/register', undefined, { email, password }, true),
