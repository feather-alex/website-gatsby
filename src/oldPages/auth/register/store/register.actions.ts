...
export type RegisterRequest = (credentials: RegisterRequestResource) => FluxStandardAction;
...
export const registerRequest: RegisterRequest = (credentials: RegisterRequestResource) => ({
