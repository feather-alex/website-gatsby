...
const AuthPageEmailSentMessage = ({ email }: Props) => (
  <Container>
    ...
    <Subheader>
      We sent an email to {email}. Check your inbox and let us know it’s really
      you.
    </Subheader>
    <HorizontalRule />
    <Paragraph2>Once you're verified:</Paragraph2>
    <LoginButton to="/login">Log In to Account</LoginButton>
    <CaptionText color={BRAND.SECONDARY_TEXT}>
      Feather Accounts are only available for active customers.
    </CaptionText>
  </Container>
);
