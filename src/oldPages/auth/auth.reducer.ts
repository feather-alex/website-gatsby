...
} from "./login/store/login.reducer";
import register, {
  initialState as registerInitialState,
} from "./register/store/register.reducer";
import verification, {
  initialState as verificationInitialState,
} from "./verification/store/verification.reducer";
