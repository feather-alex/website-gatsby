...
describe("Personal info - Selectors", () => {
  ...
  it(`should return the account's email`, () => {
    const email = selectors.getEmail({
      accounts: { personalInformation: state },
    } as GlobalState);
    expect(email).toEqual("eng@livefeather.com");
  });

  it("should return the phone number", () => {
    const phone = selectors.getPhone({
      accounts: { personalInformation: state },
    } as GlobalState);
  ...
  it("should return the address", () => {
    const address = selectors.getAddress({
      accounts: { personalInformation: state },
    } as GlobalState);
  ...
  it("should return the customer first name", () => {
    const firstName = selectors.getFirstName({
      accounts: { personalInformation: state },
    } as GlobalState);
  ...
  it("should return the customer last name", () => {
    const lastName = selectors.getLastName({
      accounts: { personalInformation: state },
    } as GlobalState);
  ...
  it("should return isUserFirstLogIn as true when accountLastAccessed at is null", () => {
    const isUserFirstLogIn = selectors.isUserFirstLogIn({
      accounts: { personalInformation: state },
    } as GlobalState);
