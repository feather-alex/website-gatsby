...
import { getPaymentProfile, removeBillingCard, addBillingCard, setPrimaryCard } from './billing.information.sagas';
...
describe('Billing Information - Sagas', () => {
  ...
  describe('Getting payment profile information', () => {
    it('should handle successfully getting payment profile information', () => {
      ...
      return expectSaga(getPaymentProfile)
        .provide([
          [matchers.call([Request, 'send'], RequestMethod.GET, '/account/payment-sources'), billingSourcesResponse]
        ])
    ...
    it('should handle unsuccessfully getting payment profile information', () => {
      ...
      return expectSaga(getPaymentProfile)
        .provide([
          [matchers.call([Request, 'send'], RequestMethod.GET, '/account/payment-sources'), Promise.reject(apiError)]
        ])
  ...
  describe('Add a new billing card', () => {
    const action: FluxStandardAction = actions.addBillingCardRequest('sourceId', false);
  ...
  describe('Set primary card', () => {
    ...
    it('should handle unsuccessfully setting a billing source to default', () => {
      ...
      return expectSaga(setPrimaryCard, action)
        .provide([
          [
            matchers.call([Request, 'send'], RequestMethod.PUT, `/account/payment-sources/${token}/default`),
            Promise.reject(apiError)
          ]
        ])
  ...
  describe('Remove billing card', () => {
    ...
    it('should handle successfully removing a billing card', () => {
      return expectSaga(removeBillingCard, action)
        .provide([
          [
            matchers.call([Request, 'send'], RequestMethod.DELETE, `/account/payment-sources/${action.payload.token}`),
