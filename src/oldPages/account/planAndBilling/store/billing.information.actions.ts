...
import { BillingResource, BillingSourcesResource } from './billing.information.types';
...
export type GetPaymentProfileSuccess = (paymentProfile: BillingSourcesResource) => FluxStandardAction;
...
export const getPaymentProfileSuccess: GetPaymentProfileSuccess = (paymentProfile: BillingSourcesResource) => ({
  type: GET_PAYMENT_PROFILE_SUCCESS,
  payload: paymentProfile
});

export const getPaymentProfileFailure: GetPaymentProfileFailure = (error: APIError) => ({
...
export type AddBillingCardRequest = (sourceId: string, isPrimary: boolean) => FluxStandardAction;
export type AddBillingCardSuccess = (billingInformation: BillingResource) => FluxStandardAction;
export type AddBillingCardFailure = (error: APIError) => FluxStandardAction;

export const addBillingCardRequest: AddBillingCardRequest = (sourceId: string, isPrimary: boolean) => ({
  type: ADD_NEW_BILLING_CARD_REQUEST,
  payload: { sourceId, isPrimary }
});

export const addBillingCardFailure: AddBillingCardFailure = (error: APIError) => ({
...
export type SetPrimaryCardSuccess = (paymentProfile: BillingSourcesResource) => FluxStandardAction;
export type SetPrimaryCardFailure = (error: APIError) => FluxStandardAction;

export const setPrimaryCardRequest: SetPrimaryCardRequest = (token: string) => ({
  type: SET_PRIMARY_CARD_REQUEST,
  payload: { token }
});

export const setPrimaryCardFailure: SetPrimaryCardFailure = (error: APIError) => ({
...
export const removeBillingCardRequest: RemoveBillingCardRequest = (token: string) => ({
  type: REMOVE_BILLING_CARD_REQUEST,
  payload: { token }
});

export const removeBillingCardFailure: RemoveBillingCardFailure = (error: APIError) => ({
