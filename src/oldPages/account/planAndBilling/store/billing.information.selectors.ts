...
export const getDefaultSource = ({ accounts }: GlobalState) =>
  accounts.billingInformation.defaultSource;
export const isFetching = ({ accounts }: GlobalState) =>
  accounts.billingInformation.isFetching;
export const getError = ({ accounts }: GlobalState) =>
  accounts.billingInformation.error;
export const getSources = ({ accounts }: GlobalState) =>
  accounts.billingInformation.sources;
