...
describe("Account Overview - Selectors", () => {
  ...
  it("should return the subscription id", () => {
    const orderNumber = selectors.getOrderNumber({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return the tax rate", () => {
    const taxRate = selectors.getTaxRate({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return the tax amount", () => {
    const taxAmount = selectors.getTaxAmount({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return the monthly subtotal", () => {
    const monthlySubtotal = selectors.getMonthlySubtotal({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return the membership fee", () => {
    const membershipFee = selectors.getMembershipFee({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return the grand total", () => {
    const grandTotal = selectors.getGrandTotal({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return end date", () => {
    const endDate = selectors.getEndDate({
      accounts: { accountOverview: state },
    } as GlobalState);
    expect(endDate).toEqual(
      formatDate(addMonths(new Date(), 6), "MMMM d, yyyy")
    );
  });
  ...
  it("should return start date", () => {
    const startDate = selectors.getStartDate({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return number of free trips", () => {
    const numberOfFreeTrips = selectors.getNumberOfFreeTrips({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return the subscription plan type", () => {
    const planType = selectors.getPlanType({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return the confirmed delivery date if it exists", () => {
    const confirmedDate = selectors.getConfirmedDeliveryDate({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return the requested delivery date", () => {
    const requestedDate = selectors.getRequestedDeliveryDate({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  it("should return true if upcoming date is in future", () => {
    ...
    const hasUpcomingDelivery = selectors.hasUpcomingDelivery({
      accounts: { accountOverview: state },
    } as GlobalState);
  ...
  describe("Get plan name", () => {
    ...
    it(`should return "${MemberPlanName}" when the current plan is a member one`, () => {
      const planName = selectors.getPlanName({
        accounts: { accountOverview: state },
      } as GlobalState);
  ...
  it("should return descounts (if any)", () => {
    ...
    const discounts = selectors.getDiscounts({
      accounts: { accountOverview: state },
    } as GlobalState);
