...
import { getHasViewedWelcomeModal, getIsFirstLogIn } from '../auth/login/store/login.selectors';
...
import { isFetching, getPlanName, hasUpcomingDelivery } from './accountOverview/store/account.overview.selectors';
...
class AccountPage extends React.Component<Props, State> {
  ...
  componentDidUpdate(prevProps: Props) {
    if (this.props.location.pathname !== prevProps.location.pathname || this.props.planName !== prevProps.planName) {
      window.scrollTo(0, 0);
  ...
  render() {
    const isPageLoading = this.props.isFetchingAccountOverview && this.props.isFetchingPersonalInfo;
      ...
      <div className="body">
        ...
        <div className="account-page">
          <div className="account-page-navigation">
            {/* DESKTOP MENU */}
            <FixedSidebarMenu sidebarWidth="100%" top={109} enableTransforms={false} bottomBoundary=".account-page">
            ...
            >
              <AccountMenu toggleMobileMenu={this.toggleMobileMenu} displayMode={DisplayMode.Sidebar} />
            </MobileAccordionMenu>
          </div>
          <div className="account-page-body">
            ...
            <Switch>
              ...
              <div className="account-content">
                ...
                <Route path="/account/membership" component={MembershipInformation} />
...
export default compose(withRouter, connect(mapStateToProps, mapDispatchToProps))(AccountPage);
