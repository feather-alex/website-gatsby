...
export type GetAccountHistorySuccess = (
  accountHistory: AccountHistoryResource
) => FluxStandardAction;
...
export const getAccountHistorySuccess: GetAccountHistorySuccess = (
  accountHistory: AccountHistoryResource
) => ({
...
export const getAccountHistoryFailure: GetAccountHistoryFailure = (
  error: APIError
) => ({
