...
export function* getFeatherPerks(action: PayloadAction<FeatherPerksRequestPayload>): SagaIterator {
  try {
    ...
    yield put(getFeatherPerksContent.success(formatFeatherPerksContentResponse(response)));
  } catch (error) {
