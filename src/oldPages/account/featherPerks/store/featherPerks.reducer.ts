...
import { FeatherPerksContentState, FeatherPerksSuccessPayload } from './featherPerks.types';
...
export default createReducer(initialState, {
  ...
  [getFeatherPerksContent.failure.type](state: FeatherPerksContentState, action: PayloadAction<APIError>) {
    state.isFetching = false;
