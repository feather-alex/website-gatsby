...
import { CompleteNote, GetReadySteps, StepNumber, StepTitle } from './FeatherDeliveryChecklist';
  ...
  <React.Fragment>
    ...
    <GetReadySteps>
      ...
      <li>
        ...
        Once your lease is signed, our local delivery team will email you within 2-3 business days to schedule your
        trip.
      </li>
    </GetReadySteps>
  </React.Fragment>
