...
export type ChangePasswordRequest = (credentials: ChangePasswordRequestResource) => FluxStandardAction;
export type ChangePasswordFailure = (error: APIError) => FluxStandardAction;

// ================== Change Password Actions ===================

export const changePasswordRequest: ChangePasswordRequest = (credentials: ChangePasswordRequestResource) => ({
...
export const changePasswordFailure: ChangePasswordFailure = (error: APIError) => ({
