...
class CheckoutSuccess extends React.Component<RouteComponentProps<MatchParams>> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Layout>
        <CheckoutSuccessPage>
          <Header2 dataCy="thank-for-your-order-header">Thank you for your order!</Header2>

          <OrderNumberText dataCy="confirmation-number" color={BRAND.SECONDARY_TEXT}>
            Order Number: {confirmationNumber}
          </OrderNumberText>

          <NextSteps>
            <NextStepsHeader>While you’re here, set up your Feather account! </NextStepsHeader>
            <NextStepsParagraph>Don’t forget to check your email for your lease.</NextStepsParagraph>
