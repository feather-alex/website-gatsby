...
export const processCheckout = createRequestAction<
  CheckoutRequestPayload,
  CheckoutSuccessPayload,
  APIError
>(CHECKOUT);
...
export const depositRequest = createRequestAction<
  DepositRequestPayload,
  {},
  APIError
>(DEPOSIT_REQUEST);
...
export const processCheckoutAmounts = createRequestAction<
  AmountsRequestPayload,
  AmountsSuccessPayload,
  APIError
>(CHECKOUT_AMOUNTS);
...
export const checkoutStepCompleted = createAction<CheckoutFormDataPayload>(
...
export const changeCheckoutStep =
  createAction<ChangeStepPayload>(CHANGE_CHECKOUT_STEP);

export const TOGGLE_DELIVERY_SAME_AS_BILLING =
  "TOGGLE_DELIVERY_SAME_AS_BILLING";
export const toggleDeliverySameAsBilling = createAction(
  TOGGLE_DELIVERY_SAME_AS_BILLING
);
