...
export const submitQuiz: SubmitQuiz = ({
  name,
  email,
}: {
  name: string;
...
export type QuizStepCompleted = (
  step: Steps,
  choice: QuizStepChoices
) => QuizActions;

export const quizStepCompleted: QuizStepCompleted = (
  step: Steps,
  choice: QuizStepChoices
) => ({
...
export type QuizActions =
  ...
  | FluxStandardAction<
    ...
    >
  | FluxStandardAction<
      typeof QUIZ_STEP_COMPLETED,
      { step: Steps; choice: QuizStepChoices }
    >
