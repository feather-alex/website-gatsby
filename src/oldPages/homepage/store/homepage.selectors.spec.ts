...
describe('Homepage - Selectors', () => {
  ...
  it('Should return the value of: isFetching', () => {
    ...
    const selected = selectors.getIsFetching({ homepage: state } as GlobalState);
  ...
  it('Should return the value of: meta', () => {
    ...
    const selected = selectors.getHomepageMeta({ homepage: state } as GlobalState);
  ...
  it('Should return the value of: hero', () => {
    ...
    const selected = selectors.getHomepageHero({ homepage: state } as GlobalState);
  ...
  it('Should return the value of: textLockup', () => {
    ...
    const selected = selectors.getHomepageTextLockup({ homepage: state } as GlobalState);
  ...
  it('Should return the value of: sections', () => {
    ...
    const selected = selectors.getHomepageSections({ homepage: state } as GlobalState);
  ...
  it('Should return the value of: bestSellers', () => {
    ...
    const selected = selectors.getHomepageBestSellers({ homepage: state } as GlobalState);
  ...
  it('Should return the value of: shopByRoom', () => {
    ...
    const selected = selectors.getHomepageShopByRoom({ homepage: state } as GlobalState);
  ...
  it('Should return the value of: reviews', () => {
    ...
    const selected = selectors.getHomepageReviews({ homepage: state } as GlobalState);
