...
describe("Enterprise - Selectors", () => {
  ...
  it("Should select: heroLockup", () => {
    ...
    const selected = selectors.getEnterpriseHeroLockup({
      enterprise: state,
    } as GlobalState);
  ...
  it("Should select: horizontalLockup", () => {
    ...
    const selected = selectors.getEnterpriseHorizontalLockup({
      enterprise: state,
    } as GlobalState);
  ...
  it("Should select: horizontalLockup2", () => {
    ...
    const selected = selectors.getEnterpriseHorizontalLockup2({
      enterprise: state,
    } as GlobalState);
  ...
  it("Should select: productShowcase", () => {
    ...
    const selected = selectors.getEnterpriseProductShowcase({
      enterprise: state,
    } as GlobalState);
  ...
  it("Should select: titleButtonLockup", () => {
    ...
    const selected = selectors.getEnterpriseTitleButtonLockup({
      enterprise: state,
    } as GlobalState);
  ...
  it("Should select: titledTripleVerticalImageLockup", () => {
    ...
    const selected = selectors.getEnterpriseTitledTripleVerticalImageLockup({
      enterprise: state,
    } as GlobalState);
  ...
  it("Should select: faqs", () => {
    ...
    const selected = selectors.getEnterpriseFAQs({
      enterprise: state,
    } as GlobalState);
  ...
  it("Should select: meta", () => {
    ...
    const selected = selectors.getEnterpriseMeta({
      enterprise: state,
    } as GlobalState);
  ...
  it("Should select: isFetching", () => {
    ...
    const selected = selectors.getEnterpriseIsFetching({
      enterprise: state,
    } as GlobalState);
  ...
  it("Should return the value of: error", () => {
    ...
    const selected = selectors.getEnterpriseError({
      enterprise: state,
    } as GlobalState);
