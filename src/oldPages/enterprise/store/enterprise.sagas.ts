...
export function* getEnterprise(action: PayloadAction<EnterpriseRequestPayload>): SagaIterator {
  try {
    ...
    yield put(getEnterpriseContent.success(formatEnterpriseContentResponse(response)));
  } catch (error) {
