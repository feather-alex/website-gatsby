...
import {
  ENTERPRISE,
  AnalyticsEventKey,
} from "../../analytics/enterprise/events";
...
export const trackCTAClick = (eventKey: AnalyticsEventKey) => () => {
  Analytics.trackEvent(
    ENTERPRISE.CLICK_CTA,
    enterpriseClickLinkPayloadMapping({ link: eventKey })
  );
};
...
export const ENTERPRISE_FEATURES = {
  1: {
    imageUrl:
      "https://img.livefeather.com/pages-new/Enterprise/dining_room.png",
    ...
    paragraphText: [
      <Paragraph
        ...
        `}
      >
        Feather offers ideal rental solutions for stagers and realtors so you
        can get your house sold quickly and at the highest price. There’s no
        long-term commitment or big upfront cost.
      </Paragraph>,
      <Paragraph key="1">
        Get modern furniture that’s comfortable and super stylish—from sofas and
        beds to tables and lamps and chairs—and have everything delivered,
        assembled, and fully set up in as little as 7 days. Feather can
        transform any four walls into a home that your clients will fall in love
        with.
      </Paragraph>,
      <Paragraph key="2">
        For flexible short-term lease options, shop our website under short-term
        plan.
      </Paragraph>,
    ],
  ...
  2: {
    imageUrl:
      "https://img.livefeather.com/pages-new/Enterprise/lunch_table.png",
  ...
  3: {
    imageUrl:
      "https://img.livefeather.com/pages-new/Enterprise/fabric_swatches.png",
  ...
  4: {
    imageUrl:
      "https://img.livefeather.com/pages-new/Enterprise/office_space.png",
  ...
  5: {
    imageUrl:
      "https://img.livefeather.com/pages-new/Enterprise/furniture_delivery.png",
