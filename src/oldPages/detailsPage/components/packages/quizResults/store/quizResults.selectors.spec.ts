...
describe("Quiz Results - Selectors", () => {
  ...
  it("should get the active quiz room", () => {
    const activeQuizRoom = getActiveQuizRoom({
      quizPackages: state,
    } as GlobalState);
  ...
  it("should get the active quiz room items", () => {
    const activeQuizRoomItems = getActiveRoomItems({
      quizPackages: state,
    } as GlobalState);
  ...
  it("should get the quiz results loading state", () => {
    ...
    const isFetchingQuizResults = getIsFetchingQuizResults({
      quizPackages: state,
    } as GlobalState);
  ...
  it("should get an error from a failed quiz results request", () => {
    ...
    const quizResultsError = getQuizResultsError({
      quizPackages: state,
    } as GlobalState);
