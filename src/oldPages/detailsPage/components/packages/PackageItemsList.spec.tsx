...
const mockItems: PkgItem[] = [
  {
    ...
    retailPrice: 699,
    image: {
      mobile: 'https://img.livefeather.com/products/akepa-dresser/images/x4048A-main-desktop.jpg',
      desktop: 'https://img.livefeather.com/products/akepa-dresser/images/x4048A-main-desktop.jpg'
    },
    ...
    displayOrder: 0,
    availability: [
      { deliveryArea: DeliveryAreaIdentifier.NY, isEnabled: true, isInStock: true, stockExpectedDate: null },
      { deliveryArea: DeliveryAreaIdentifier.SF, isEnabled: true, isInStock: false, stockExpectedDate: null },
      { deliveryArea: DeliveryAreaIdentifier.LA, isEnabled: true, isInStock: true, stockExpectedDate: null }
    ]
  }
];
