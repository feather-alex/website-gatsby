...
export type GetProductDetailsRequest = (payload: ProductDetailsRequestPayload) => FluxStandardAction;

export const getProductDetailsRequest: GetProductDetailsRequest = (payload: ProductDetailsRequestPayload) => ({
...
export type GetProductDetailsSuccess = (payload: FullProductDetails | FullProductDetails[]) => FluxStandardAction;
...
export const getProductDetailsFailure: GetProductDetailsFailure = (error: APIError) => ({
