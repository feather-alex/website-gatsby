...
describe('Product Details - Selectors', () => {
  describe('Redux Selectors', () => {
    it('Should return the value of: data (single product)', () => {
      ...
      const selected = selectors.getProductDetails({ productDetails: state } as GlobalState);
    ...
    it('Should return the value of: isFetching', () => {
      ...
      const selected = selectors.getIsFetching({ productDetails: state } as GlobalState);
    ...
    it('Should return the value of: error', () => {
      ...
      const selected = selectors.getError({ productDetails: state } as GlobalState);
