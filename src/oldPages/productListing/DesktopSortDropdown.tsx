...
import Select, { ValueType, Styles, OptionProps, components } from 'react-select';

import { FilterMap } from './filter.service';
import { getCurrentOption, OptionValue, isValueType, getClickArgs, options } from './DesktopSortDropdown.service';
...
const customStyles: Styles = {
  ...
  singleValue: () => ({ width: 'max-content', fontWeight: 500, fontSize: '16px', lineHeight: '24px' }),
  group: () => ({}),
  groupHeading: () => ({
    paddingTop: '8px'
  })
...
const DesktopSortDropdown = ({ handleSortOptionClick, activeFilters }: Props) => {
