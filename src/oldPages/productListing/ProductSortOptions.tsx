...
const ProductSortOptions = ({ handleSortOptionClick, activeFilters, isMobileBreakpoint }: Props): JSX.Element => {
    ...
    >
      ...
      >
        <span
          ...
          `}
        >
          <Title1 color={isCheckedDefault ? BRAND.PRIMARY_TEXT : BRAND.SECONDARY_TEXT} isBold={isCheckedDefault}>
            Default order
          </Title1>
        </span>
      </SelectInput>
      ...
      >
        <span
          ...
          `}
        >
          <Title1 color={isCheckedPriceDesc ? BRAND.PRIMARY_TEXT : BRAND.SECONDARY_TEXT} isBold={isCheckedDefault}>
      ...
      >
        <span
          ...
          `}
        >
          <Title1 color={isCheckedPriceAsc ? BRAND.PRIMARY_TEXT : BRAND.SECONDARY_TEXT} isBold={isCheckedDefault}>
      ...
      >
        <span
          ...
          `}
        >
          <Title1 color={isCheckedTitle ? BRAND.PRIMARY_TEXT : BRAND.SECONDARY_TEXT} isBold={isCheckedDefault}>
            A to Z
          </Title1>
        </span>
      </SelectInput>
