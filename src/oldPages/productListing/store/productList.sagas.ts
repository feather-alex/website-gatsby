...
export function* getProductList(action: GetProductListRequestAction): SagaIterator {
  try {
    ...
    const formattedResults = formatProductListResponse(response, action.payload.isInfiniteLoading);
