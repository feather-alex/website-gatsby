  ...
  describe('getProductListRequest', () => {
    ...
    it('Should handle a successful execution', () => {
      ...
      return expectSaga(sagas.getProductList, mockAction)
        .provide([
          [
            matchers.call([Request, 'send'], RequestMethod.POST, '/products', undefined, mockAction.payload.body),
            expectedResponse
          ],
          [
            matchers.call(
        ...
        .put(getProductListSuccess(formatProductListResponse(expectedResponse, mockAction.payload.isInfiniteLoading)))
        .run();
    });
