...
describe('ProductList - Selectors', () => {
  describe('Redux Selectors', () => {
    it('Should return the value of meta', () => {
      ...
      const selected = selectors.getProductListMeta({ productList: state } as GlobalState);
    ...
    it('Should return the value of products', () => {
      ...
      const selected = selectors.getProducts({ productList: state } as GlobalState);
    ...
    it('Should return the value of isFetching', () => {
      ...
      const selected = selectors.getIsFetching({ productList: state } as GlobalState);
    ...
    it('Should return the value of error', () => {
      ...
      const selected = selectors.getError({ productList: state } as GlobalState);
