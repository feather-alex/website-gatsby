...
export type SendInquiryRequest = (formValues: ContactFormData) => FluxStandardAction;

export const sendInquiryRequest: SendInquiryRequest = (formValues: ContactFormData) => ({
