...
const FLOYD_PRODUCTS = [
  "the-floyd-sofa",
  "the-floyd-platform-bed",
  "the-floyd-shelving-system",
];
const FLOYD_VARIANTS = [
  "three-seater-white",
  "full-queen-black",
  "tall-white",
  "three-seater-chaise-white",
];
...
const handleCTAAnalytics = () =>
  Analytics.trackEvent(
    FLOYD.CLICK_CTA,
    floydPayloadMapping({ location: floydCTALocation.BEST_OF_BOTH_CTA })
  );
...
const Floyd = () => {
  ...
  return (
    <Layout>
      ...
      <ProductShowcase
        title="Shop Floyd"
        productIdentifiers={FLOYD_PRODUCTS}
        variants={FLOYD_VARIANTS}
      />
