...
const WhyWeLoveFloyd = ({
  ...
  <LoveFloydContainer>
    ...
    <ImageWithText
      ...
      paragraphText={
        <Header3>
          Beautiful styles that can be easily paired with Feather furniture.
        </Header3>
      }
    ...
    <ImageWithText
      isMobileBreakpoint={isMobileBreakpoint}
      paragraphText={
        <Header3>Adaptable modular designs that fit any home.</Header3>
      }
    ...
    <ImageWithText
      isMobileBreakpoint={isMobileBreakpoint}
      paragraphText={
        <Header3>Quality craftsmanship and durable materials.</Header3>
      }
