...
export type FetchOpenPositionsSuccess = (jobsByDepartments: Department[]) => FluxStandardAction;
export const fetchOpenPositionsSuccess: FetchOpenPositionsSuccess = (jobsByDepartments: Department[]) => ({
