...
describe('About Selectors', () => {
  ...
  describe('getDepartments', () => {
    it('should return an array of all the departments at Feather', () => {
      ...
      const departments = selectors.getDepartments({ about: state } as GlobalState);
  ...
  describe('getOpenPositions', () => {
    it('should return an array with only departments that have open positions', () => {
      ...
      const departmentsWithOpenPositions = selectors.getOpenPositions({ about: state } as GlobalState);
