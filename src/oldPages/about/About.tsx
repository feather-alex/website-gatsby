...
const About = () => {
  ...
  return (
    <Layout>
      ...
      >
        <Subheader2>
          Feather launched in 2017 with a simple concept—furniture that fits the
          way we live today. City renters move on average every 1-2 years.
          Tastes evolve, living arrangements change, budgets fluctuate, and many
          can’t afford or don’t want to commit to quality furniture so they end
          up resorting to cheaper alternatives that aren’t built to last. As a
          result, 20 billion pounds of furniture end up in landfills annually
          (that’s about the same amount of plastic that ends up in the oceans
          every year). This pattern isn’t sustainable.
          <br />
          <br />
          We believe furniture shouldn’t involve so much compromise. Affordable
          and well-made. Convenient and sustainable. Smart and stylish. These
          things are all possible with Feather. We built a more responsible
          approach to furniture, one that’s grounded in rental, reuse, and
          refurbishment. There’s still a lot of work to be done, but we’re proud
          to be offering a more circular approach and helping a new generation
      ...
      >
        ...
        <Paragraph1>
          We take immense pride in our work, in the quality of our product, and
          the excellence of the Feather experience. These are the ground rules
          that guide our processes, our partnerships, and help us operate a
