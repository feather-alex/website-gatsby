...
const FeatherArchLogo = ({
  ...
  <svg height={height} viewBox="0 0 104 181" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
    ...
    />
    <path d="M104 162.342v18.659H0l68.144-39.271L104 162.342z" style={{ fill: archFloorColor, transition }} />
  </svg>
);
