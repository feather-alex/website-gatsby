...
export type NewsletterSignupRequest = (requestData: NewsletterSignupRequestResource) => FluxStandardAction;
...
export const newsletterSignupRequest: NewsletterSignupRequest = (requestData: NewsletterSignupRequestResource) => ({
...
export const newsletterSignupFailure: NewsletterSignupFailure = (error: APIError) => ({
