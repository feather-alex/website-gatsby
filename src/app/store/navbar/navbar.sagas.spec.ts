...
describe("Navbar Sagas", () => {
  it("should handle the dismiss navbar banner action and dispatch the reset action after a delay", () => {
    return expectSaga(handleDismissNavbarBanner)
      .put(resetNavbarBanner())
      .run(410); // force saga to run 10ms longer than the delay before resetNavbarBanner
  });
