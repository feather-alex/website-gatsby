...
export type SelectMembership = (
  membershipState: MembershipState
) => PlanActionTypes;

export const changeMembershipSelection: SelectMembership = (
  membershipState: MembershipState
) => ({
...
export type ZipcodeSubmit = (
  zipcodeRequest: ZipcodeRequestResource
) => PlanActionTypes;
export type ZipcodeSubmitSuccess = (
  postalData: ZipcodeResponseResource
) => PlanActionTypes;
export type ZipcodeSubmitFailure = (error: APIError) => PlanActionTypes;

export const zipcodeSubmit: ZipcodeSubmit = (
  zipcodeRequest: ZipcodeRequestResource
) => ({
...
export const zipcodeSubmitSuccess: ZipcodeSubmitSuccess = (
  postalData: ZipcodeResponseResource
) => ({
...
export const zipcodeSubmitFailure: ZipcodeSubmitFailure = (
  error: APIError
) => ({
