...
describe("Plan - selectors", () => {
  ...
  it("should return the delivery zip code", () => {
    const deliveryZipcode = selectors.getDeliveryZipCode({
      plan: mockMemberState,
    } as GlobalState);
  ...
  it("should return the delivery area indentifier", () => {
    const deliveryAreaIdentifier = selectors.getDeliveryAreaIdentifier({
      plan: mockMemberState,
    } as GlobalState);
  ...
  it("should return if the delivery zip code is in our delivery zone", () => {
    const isInDeliveryZone = selectors.getIsInDeliveryZone({
      plan: mockMemberState,
    } as GlobalState);
  ...
  it("should return if the plan is set", () => {
    const isPlanSet = selectors.getIsPlanSet({
      plan: mockMemberState,
    } as GlobalState);
  ...
  it("should return if email is submitted", () => {
    const isEmailSubmitted = selectors.getIsEmailSubmitted({
      plan: mockMemberState,
    } as GlobalState);
  ...
  describe("Get membership state", () => {
    it("should return NONE if membership is not set", () => {
      const membershipState = selectors.getMembershipState({
        plan: initialState,
      } as GlobalState);
  ...
  describe("Get monthly membership fee", () => {
    it("should return 19 if membership is selected", () => {
      const monthlyMembershipFee = selectors.getMonthlyMembershipFee({
        plan: mockMemberState,
      } as GlobalState);
  ...
  describe("Get cart minimum", () => {
    it("should return 29 if membership is selected", () => {
      const cartMinimum = selectors.getCartMinimum({
        plan: mockMemberState,
      } as GlobalState);
  ...
  describe("Get delivery fee", () => {
    it("should return 0 if membership is selected", () => {
      const deliveryFee = selectors.getDeliveryFee({
        plan: mockMemberState,
      } as GlobalState);
  ...
  describe("Get rental length", () => {
    it("should return 12 if membership is selected", () => {
      const rentalLength = selectors.getRentalLength({
        plan: mockMemberState,
      } as GlobalState);
  ...
  describe("Get select plan button text", () => {
    it(`should return the correct text in the initial state`, () => {
      const buttonText = selectors.getSelectPlanButtonText({
        plan: initialState,
      } as GlobalState);
  ...
  describe("Get delivery timeline text", () => {
    it("should return the correct timeline when membership is selected in DC", () => {
      ...
      const deliveryTimelineText = selectors.getDeliveryTimelineText({
        plan: planState,
      } as GlobalState);
      expect(deliveryTimelineText).toEqual(
    ...
    it.each([
      ...
      "should return the correct timeline when membership is selected in %s",
