        ...
        .provide([
          ...
          [
            matchers.call(
              ...
              ZIPCODE.ENTER,
              enterZipcodePayloadMapping(analyticsPayload)
            ),
            noop,
          ],
        ])
    ...
    it("should handle unsuccessfully submitting a zip code and show an error", () => {
      ...
      return expectSaga(handleZipcode, action)
        ...
        .provide([
          ...
          [
            matchers.put(
              stopSubmit("planForm", { zipcode: "outside delivery area" })
            ),
            noop,
          ],
          [
      ...
      return expectSaga(handleMembershipChange, action)
        ...
        .put(
          showNavbarBanner({
            ...
            message:
              "You’ve selected Membership : start choosing items to add to your plan!",
          })
        )
      ...
      return expectSaga(handleMembershipChange, action)
        ...
        .put(
          showNavbarBanner({
            bannerType: BannerType.Success,
            message:
              "You’ve selected Short-Term Plan : start choosing items to add to your plan!",
          })
        )
        .put(normalizeCartPrices(action.payload.membershipState))
        .put(dismissNavbarBanner())
